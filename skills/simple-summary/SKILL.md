...
3. The body, carried by drawings. This is most of the page
4. What is open or next, as status marks with a few words beside them, omitted if genuinely empty
...
**Constraints.** No paragraph longer than two sentences. Bullets under ten words. Must survive Print to PDF, so no fixed viewport heights and nothing that only appears on scroll. No animation, no decoration, no dark variant.
